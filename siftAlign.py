...
if __name__ == '__main__':
    ...
    #摆正社保卡背面
    img = cv2.imread('Demo_input0/sscb.jpg')
    img2 = get_sandard_card(img,0)

    # 摆正社保卡正面
    img = cv2.imread('Demo_input0/sscf.jpg')
    img3 = get_sandard_card(img, 1)


    # 摆正身份证背面
    img = cv2.imread('Demo_input0/idb.jpg')
    #img0是摆正好的图片，下面同理
    img0 = get_sandard_card(img,2)

    # 摆正身份证正面
    img = cv2.imread('Demo_input0/idf.jpg')
    img1 = get_sandard_card(img,3)
